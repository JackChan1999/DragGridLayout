 ...
 * Version：1.0
 * time：2017/5/24 16:42
 * des ：${TODO}
 * gitVersion：2.12.0.windows.1
 * updateAuthor：AllenIverson
 * updateDate：2017/5/24 16:42
 * updateDes：${TODO}
 * ============================================================
 */
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DragGridLayout2 dragGridLayout = (DragGridLayout2) findViewById(R.id.dragGridLayout);
        ...
        final DragGridLayout2 dragGridLayout2 = (DragGridLayout2) findViewById(R.id.dragGridLayout2);
        ...
        //设置条目点击监听
        dragGridLayout.setOnDragItemClickListener(new DragGridLayout2.OnDragItemClickListener() {
            @Override
        ...
        dragGridLayout2.setOnDragItemClickListener(new DragGridLayout2.OnDragItemClickListener() {
            @Override
            public void onDragItemClick(TextView tv) {
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DRAG_LOCATION://移动
                    ...
                    if (exchangeItemPosition > -1 && dragView != gridLayout.getChildAt
                            (exchangeItemPosition)) {
                        //移除
